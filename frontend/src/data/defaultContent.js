export const DEFAULT_SETTINGS = {
  ...
  category: "Premium Taxi Service & Curated Himachal Tours",
  rating: 5.0,
  reviewCount: 18,
  googleMapsUrl:
    "https://www.google.com/maps/search/?api=1&query=Rana+Tour+And+Travels+Balvir+Colony+Barnoh+Himachal+Pradesh+174303",
  email: "info@ranatourandtravels.com",
};
...
export const DEFAULT_SERVICES = [
  ...
  {
    title: "Himachal Nau Devi & Shaktipeeth Darshan",
    description: "Dedicated spiritual yatra covering Himachal's revered Shaktipeeths: Mata Chintpurni, Jwala Ji (eternal flame), Kangra Brajeshwari Devi, Chamunda Devi, Baglamukhi, and Mata Naina Devi.",
    image: "/images/services/himachal-devi-darshan.jpg",
    badge: "Devi Darshan Yatra",
    category: "himachal",
  },
  {
    title: "Manikaran Sahib & Parvati Valley Pilgrimage",
    description: "Sacred trip to historic Gurudwara Sri Manikaran Sahib, famous for natural healing hot sulfur springs, Langar, Ram temple, and scenic riverside drive through Parvati Valley and Kasol.",
    image: "/images/services/manikaran-sahib.jpg",
    badge: "Hot Springs & Gurudwara",
    category: "himachal",
  },
  {
    title: "Baijnath Shiva Temple & Kangra Heritage Tour",
    description: "Visit the iconic 13th-century stone Jyotirlinga Baijnath Temple, Kangra Fort, Chamunda Nandikeshwar Dham, and scenic tea gardens of Palampur with knowledgeable local drivers.",
  ...
  },
  {
    ...
    description: "Curated 1-day and multiday local tours covering hidden waterfalls, apple orchards, mountain viewpoints, ancient wooden shrines, and vibrant local handicraft bazaars.",
    image: "/images/services/local-sightseeing.jpg",
    badge: "Local Hidden Gems",
    category: "himachal",
  },
  {
    title: "Curated Multi-Day Himachal Hill Tours",
    description: "Bespoke holiday circuits across Shimla, Kufri, Kullu, Manali, Rohtang Pass, Dharamshala, Dalhousie, and Spiti Valley with vetted hotels and scenic hill routes.",
    image: "/images/services/himachal-tours.jpg",
    badge: "Top Rated Packages",
    category: "himachal",
  },
  ...
  // --- TEMPLES OUTSIDE HIMACHAL ---
  {
    ...
    description: "Direct taxi service from Himachal/Chandigarh to Sri Harmandir Sahib (Golden Temple), Jallianwala Bagh, and the high-energy evening Wagah Border Beating Retreat ceremony in Punjab.",
    image: "/images/services/golden-temple.jpg",
    badge: "Amritsar Pilgrimage",
    category: "temples",
  },
  {
  ...
  },
  {
    ...
    badge: "Haridwar & Rishikesh",
    category: "temples",
  },
  {
    title: "Khatu Shyam Ji & Salasar Balaji Rajasthan Yatra",
  ...
  {
    title: "Ayodhya Ram Mandir & Kashi Vishwanath Tour",
...
export const DEFAULT_FAQS = [
  {
    title: "How do I book a taxi or tour package?",
    description:
      "Submit an enquiry through our quick form, or call/WhatsApp us directly. Our team verifies vehicle availability and sends an all-inclusive customized quote.",
  },
  {
    title: "Are all tolls, parking, and driver allowances included?",
    description:
      "Yes! When we provide you a quote, all state taxes, mountain toll taxes, parking fees, and driver charges are clearly outlined so there are no surprises.",
  },
  {
    title: "Which vehicles are available in your fleet?",
    description:
      "We offer Dzire and Etios sedans, Toyota Innova and Innova Crysta SUVs, Mahindra Scorpio/XUV, and 12-to-17-seater luxury Tempo Travellers.",
  },
  {
    title: "Can I customize the pickup and drop locations?",
    description:
      "Absolutely. We offer doorstep pickups from Chandigarh, Delhi NCR, Ambala, Kalka, Una, Kangra, or directly from your hotel/airport.",
  },
  {
    title: "How experienced are your mountain drivers?",
    description:
      "All our chauffeurs are licensed professionals with over 5–10 years of experience on Himalayan routes like Rohtang, Spiti, Kinnaur, and Jalori Pass.",
  },
];

export const DEFAULT_ABOUT = {
  ourStory:
    "Founded with a passion for the pristine Himalayan landscapes, Rana Tour And Travels provides premier passenger transportation and curated tourism services. Based in Balvir Colony, VPO Barnoh, Himachal Pradesh, we take pride in sharing the breathtaking beauty of Himachal with travellers from across the country and the world.",
  ourApproach:
    "We believe a journey should be as memorable and relaxing as the destination itself. By combining spotless vehicles, experienced mountain chauffeurs, and personalized customer care, we ensure your mountain road trip is safe, smooth, and unforgettable.",
  whyChooseUs:
    "With a 5.0 Google Rating, verified drivers, round-the-clock roadside support, and honest upfront quotes, we are the trusted travel partner for thousands of happy families and travelers every year.",
};
